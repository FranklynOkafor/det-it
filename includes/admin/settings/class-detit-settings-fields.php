...
class DetIt_Settings_Fields
{
    /**
     * Get the settings fields schema.
     *
     * @return array
     */
...
// Support legacy return for now if needed, but we should update caller
// return DetIt_Settings_Fields::get_fields();
